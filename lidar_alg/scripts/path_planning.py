...
def rrt_star(start, goal, map_array, iterations=3500, delta_q=1.0, goal_tolerance=3.0, bias_factor=0.1):
...
class MapSubscriber:
    def __init__(self):
        ...
        self.start = (self.start[0] + 20, self.start[1] + 20)
        self.goal = (0, 0)
    ...
    def odom_callback(self, data):
        ...
        self.goal = ((self.goal[0] + 1) * 20, (self.goal[1] + 1) * 20)
    ...
    def publish_path(self):
        ...
        if self.path is not None:  # Check if self.path is not None
            ...
            for point in self.path:
                ...
                pose.pose.position.y = point[1] / 20 - 1
